<div class="absolute top-[950px] md:top-[1000px] max-w-[1440px] mx-auto">
    <div class="">
        <div class="flex md:flex-row flex-col ">
            <div class="flex flex-col w-[75%] md:w-[55%] xl:w-[35%]"> ">
                ...
                <div class="flex gap-2 md:gap-[24px] mt-[60px] flex-wrap justify-start w-full max-w-[100%]">
            ...
            <div class="flex grow-1 ml-[50px] lg:ml-[40px] items-center md:w-[65%]">
