<style>
  ...
  @media (max-width: 768px) {
    ...
    /* Les terminaux prennent toute la largeur */
    .w-full {
      width: 100%;
    }

    /* Ajuster la taille de la police du terminal sur mobile */
    .terminal-linux, .terminal-windows {
      font-size: 14px;
    }

    /* Ajuster l'espace entre les éléments du terminal */
    .terminal-linux, .terminal-windows {
      padding: 10px;
    }
  ...
  @media (max-width: 480px) {
    ...
    /* Réduire les espacements pour un meilleur ajustement */
    .terminal-linux, .terminal-windows {
      padding: 8px;
    }
