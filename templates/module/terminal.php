...
<div class="w-full max-w-4xl flex flex-col gap-8 animate-terminal">
    ...
    <!-- Terminal Linux -->
    <div id="terminal-linux" class="w-full bg-black rounded-lg shadow-lg font-mono hidden">
    ...
    <!-- Terminal Windows -->
    <div id="terminal-windows" class="w-full bg-gray-800 rounded-lg shadow-lg font-mono hidden">
      <div class="bg-gray-800 px-4 py-2 flex items-center justify-between rounded-t-lg">
        <div class="flex space-x-2">
          <div class="w-3 h-3 bg-red-500 rounded-full"></div>
          <div class="w-3 h-3 bg-yellow-500 rounded-full"></div>
