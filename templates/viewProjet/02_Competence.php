    ...
    <div class="">
        <div class="bg-[#191C36] w-full h-auto lg:w-[350px] lg:h-[250px] p-4 rounded-lg border-white/20 border-[1px] drop-shadow-[0_15px_15px_rgba(240,240,240,0.09)] w-[100%] h-[100px] flex ">
            <div class="text-white">
                ...
                <div class=""> - <?php echo $textCompetence['competence1bis'] ?></div>
            </div>
        </div>
    </div>
    <!-- card -->
    <div class="">
        <div class="bg-[#191C36] w-full h-auto lg:w-[350px] lg:h-[250px]  p-4 rounded-lg border-white/20 border-[1px] drop-shadow-[0_15px_15px_rgba(240,240,240,0.09)] w-[100%] h-[100px] flex ">
            <div class="text-white">
                ...
                <div class=""> - <?php echo $textCompetence['competence2bis'] ?></div>
            </div>
        </div>
    </div>
    <!-- card -->
    <div class="">
        <div class="bg-[#191C36] w-full h-auto lg:w-[350px] lg:h-[250px]  p-4 rounded-lg border-white/20 border-[1px] drop-shadow-[0_15px_15px_rgba(240,240,240,0.09)] w-[100%] h-[100px] flex ">
            <div class="text-white">
                ...
                <div class=""> - <?php echo $textCompetence['competence3bis'] ?></div>
            </div>
        </div>
    </div>
    <!-- card -->
    <div class="">
        <div class="bg-[#191C36] w-full h-auto lg:w-[350px] lg:h-[250px]  p-4 rounded-lg border-white/20 border-[1px] drop-shadow-[0_15px_15px_rgba(240,240,240,0.09)] w-[100%] h-[100px] flex ">
            <div class="text-white">
                ...
                <div class=""> - <?php echo $textCompetence['competence4bis'] ?></div>
            </div>
        </div>
    </div>
    <div class="">
